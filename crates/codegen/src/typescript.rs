...
\n"
    ...
    pub(crate) fn map_field_type(field_type: &forgedb_parser::FieldType) -> String {
        match field_type {
            ...
            // #254: a timestamp crosses JSON as an RFC 3339 string, never a
            // number.  A number would have made the seconds -> micros change
            // SILENT for every client; a string fails loudly and immediately.
