# ForgeDB Advanced Features Addendum
...
Use blockchain consensus for distributed transactions across nodes in a ForgeDB cluster.
...
- Execute during `forgedb generate`
...
import { CompileTimeMacro, MacroContext } from 'forgedb/macros'
...
import { RuntimeMacro, MacroContext } from 'forgedb/macros'
...
import { RuntimeMacro } from 'forgedb/macros'
...
```typescript
// forgedb.macros.ts (in your project)

import { MacroRegistry } from 'forgedb/macros'
...
# Test macro
forgedb macro test git_hash

# Output: a3f5c8d9e2b1f4c7a6d8e9f0a1b2c3d4e5f6a7b8

# Generate with specific macro
forgedb generate --macro-only git_hash,build_timestamp
```
...
import { CompileTimeMacro } from 'forgedb/macros'
import { execSync } from 'child_process'
import os from 'os'
...
import { createMockContext } from 'forgedb/testing'
