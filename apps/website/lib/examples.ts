...
export const catalog: ExampleMeta[] = [
  ...
  { slug: "publishing-membership", title: "Publishing & Membership", origin: "Adapted", provenance: "Ghost (MIT)", models: 7, showcases: "@fulltext, three many-to-many pairs, a subscription-billing join, and ISO currency as a length-bounded string." },
  ...
  { slug: "banking-ledger", title: "Banking Ledger", origin: "Synthetic", provenance: "Synthetic", models: 6, showcases: "Double-entry transactions, a Transfer dual FK to Account, joint-account many-to-many, and length-bounded string currency codes." },
  { slug: "airline-reservations", title: "Airline Reservations", origin: "Synthetic", provenance: "Synthetic", models: 7, showcases: "Flight dual FK to Airport, a unique-seat composite index (seat lock), and IATA codes as inline fixed-width `string(3!)`." },
