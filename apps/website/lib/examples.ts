...
export const catalog: ExampleMeta[] = [
  ...
  { slug: "airline-reservations", title: "Airline Reservations", origin: "Synthetic", provenance: "Synthetic", models: 7, showcases: "Flight dual FK to Airport, a unique-seat composite index (seat lock), and IATA codes as length-bounded strings." },
