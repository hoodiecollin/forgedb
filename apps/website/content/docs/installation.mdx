...
These crates know nothing about any specific schema. Every schema-tailored surface —
types, tables, queries, filters, relations, API routes — is generated per app at compile
time. See [core concepts](/docs/concepts/) for the identity invariant.
