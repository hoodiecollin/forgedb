...
When **both** models list the other with `[..]` and neither side is a foreign key, the
parser auto-detects a many-to-many relationship and generates a junction table.
