...
|-------|----------|---------|-------|
| `+` | prefix | auto-generate | `u32`/`u64`/`uuid`/`timestamp` only — `uuid`/`timestamp` fill on create; integer `+u32`/`+u64` is a marker, **not yet** auto-incremented ([#187](https://github.com/hoodiecollin/forgedb/issues/187)) |
