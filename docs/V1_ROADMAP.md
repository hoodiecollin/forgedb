...
### Phase 5 — Ship · [#93](https://github.com/hoodiecollin/forgedb/issues/93) · *targeted Tier 2/3 for the design-partner bar* · 🚧 IN PROGRESS (WS1/2/5 landed)
...
- **WS3 — Docs (incl. "what v1 is / isn't"). ⏳ PENDING** — deliberately last so it documents the real shipped results of WS1/2/4/5/6.
- **WS4 — Distribution (`cargo install` / prebuilt binaries + pinned substrate versions). ⏳ PENDING.**
- **WS6 — Semver / stability policy (schema language + substrate ABI). ⏳ PENDING.**
