...
impl UserStorage {
    ...
    pub fn checkpoint(&mut self) {
        ...
        self.email_col.flush().expect("Failed to fsync column on checkpoint");
...
impl PostStorage {
    ...
    pub fn commit(&mut self) -> std::io::Result<()> {
        self.id_col.flush()?;
        self.title_col.flush()?;
        self.views_col.flush()?;
        self.published_col.flush()?;
        self.author_col.flush()?;
        self.created_at_col.flush()?;
        self.tombstones.flush()?;
        Ok(())
    }
    ...
    pub fn checkpoint(&mut self) {
        ...
        self.views_col.flush().expect("Failed to fsync column on checkpoint");
        self.published_col.flush().expect("Failed to fsync column on checkpoint");
